...
The DECIDe DCAT architecture follows a federated model: each participating city or organization maintains its own DCAT catalog, and the Federating Catalogue aggregates those member catalogs by following their LDES feeds and replicating, then republishing its contents.
