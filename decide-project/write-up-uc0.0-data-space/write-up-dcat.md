...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ----------------- | ---------- | ------------------------- | ------------------------- |
| [ELI](https://github.com/lblod/app-decide/blob/development/scripts/project/publish_dataset/config.json#L26C29-L26C77)  | Dataspace authentication   | Belgium / Germany | Government | Yes                       | Yes                       |
| [Codelists (SDG)](https://github.com/lblod/app-decide/blob/development/scripts/project/publish_dataset/config.json#L3)                                                | Dataspace authentication   | Belgium / Germany | Government | Yes                       | Yes                       |
| [Restricted Mobility Zone (RMZ)](https://github.com/lblod/app-decide/blob/development/scripts/project/publish_dataset/config.json#L14C29-L14C91) | Dataspace authentication   | Belgium / Germany | Government | Yes                       | Yes                       |
| [Human validation](https://github.com/lblod/app-decide/blob/development/scripts/project/publish_dataset/config.json#L36)                                             | Dataspace authentication   | Belgium / Germany | Government | Yes                       | Yes                       |
...
* ELI (expressions in config): ELI (meta)data for expression + work + manifestation + AI annotations
* Codelists (SDG) (codelists in config): Codelist annotations for SDGs and impact
* Restricted Mobility Zone (rmz in config): RMZ annotations + locations and timing
* Human validation (human-validations in config): Human review annotations (except UC2)
