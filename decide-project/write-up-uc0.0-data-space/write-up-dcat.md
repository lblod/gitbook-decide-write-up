...
#### Frontend DCAT 
This is the web application hosting the web interface that the user can search and view DCAT Catalogs, Datasets and Distributions in. It is written in Ember and uses the endpoint provided by mu-resources to realize its functionality.
